...
> >
> > 1. {% tool [Interactive Jupyter Notebook](interactive_tool_jupyter_notebook) %}. Note that on some instances this is called {% tool [Interactive JupyTool and notebook](interactive_tool_jupyter_notebook) %}:
> > 2. Click Run Tool
