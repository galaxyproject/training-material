...
5. **Ask for help!**
   - Where?
     {% if include.sc %}- In the [User community chatspace in Slack]([https://matrix.to/#/#Galaxy-Training-Network_galaxy-single-cell:gitter.im](http://gxy.io/gtn-slack)) in our #single-cell-users channel   
