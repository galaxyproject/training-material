Galaxy Introduction: From Peaks to Genes
========================================
...
It could be nice to combine in this tutorial:
- [Previous course "From Peaks to Genes"](../tmp/Introduction.md)
- [Galaxy 101-1: The first thing you should try](../tmp/Galaxy101-1.md)
