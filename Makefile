...
install: clean ## install dependencies
	$(ACTIVATE_ENV) && \
		...
		gem install addressable:'2.5.2' jekyll:'3.8.5' jekyll-feed jekyll-environment-variables jekyll-github-metadata jekyll-scholar:'5.16.0' csl-styles awesome_bot html-proofer pkg-config
.PHONY: install
