...
>    >
>    > ![](../../images/crispr-screen/cutadapt_trimmed_sequences_plot_5.png)
>    >
>    {: .details}
>
{: .hands_on}
...
![ESD counts](../../images/crispr-screen/esd_plot.png){:width="80%"}
...
> >
> > ![MAGeCK test pvalues](../../images/crispr-screen/fli1_plot.png){:width="80%"}
> >
> {: .solution}
>
{: .question}
...
>    > >
>    > > ![Volcano plot](../../images/crispr-screen/volcanoplot.png){:width="80%"}
>    > >
>    > {: .solution}
>    >
>    {: .question}
...
>        - {% icon param-text %} *"Only label top most significant"*: `10`
>
>   ![Volcano plot mle](../../images/crispr-screen/mageck_mle_apr_volcano.png){:width="80%"}
>
