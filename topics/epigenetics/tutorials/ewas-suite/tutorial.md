...
This exercise uses datasets from the Cell publication by Hugo, Willy, et al., 2015 {% cite Hugo2015 %}. with the goal to identify differentially methylated regions and positions associated with treatment resistant melanomas.
