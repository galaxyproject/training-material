...
This exercise uses datasets from the Cell publication by {% cite Hugo2015 %}. with the goal being the identifcation of differentially methylated regions and positions associated with treatment resistant melanomas.
