...
>    {: .tip}
>
>    ![fastqbefore](../../images/tal1/fastqc_before.png "Sequence quality per base generated by FastQC <b>before</b> end trimming.")
>
>    > ### {% icon question %} Questions
>    >
...
>    {: .question}
>
>    ![fastqafter](../../images/tal1/fastqc_after.png "Sequence quality per base generated by FastQC <b>after</b> end trimming.")
{: .hands_on}
...
>     {: .question}
>
>     ![heatmap](../../images/tal1/plotCorrelation_heatmap_pearson_1kb.png "Heatmap of correlation matrix generated by <b>plotCorrelation</b>.")
{: .hands_on}

For additional information on how to interpret **plotCorrelation** plots, read the information [here](https://deeptools.readthedocs.io/en/latest/content/tools/plotCorrelation.html#background)
...
>
>    ![fingerprintimage](../../images/tal1/plotFingerprint_graph_v2.png "Graph of IP strength from **plotFingerprint**.")
>
>    > ### {% icon question %} Questions
>    >
...
>    {: .question}
>
>    ![runx1](../../images/tal1/Trackster_Runx1_locus.png "The Runx1 locus.")
{: .hands_on}
...
>
> 1. **Run bamCompare** {% icon tool %} with the following parameters:
...
>
> 3. **Rename** files to reflect their content
{: .hands_on}
...
> ### {% icon hands_on %} Hands-on: plot a Heatmap using computeMatrix output
>
