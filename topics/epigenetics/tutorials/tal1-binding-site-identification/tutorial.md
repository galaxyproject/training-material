...
>    - {% icon param-files %} *"Select fastq dataset"*: Select all of the trimmed read FASTQ files
>
...
>    {: .question}
>
> 4. **Samtools idxstats** {% icon tool %}: Run idxstats to get statistics of the alignment.
...
>     - *"Bin size in bp"*: 100
>
> 2. **plotCorrelation** {% icon tool %}: Run plotCorrelation from the deepTools package to visualize the results.
...
>
> 1. **plotFingerprint** {% icon tool %}: Run plotFingerprint from the deepTools package to assess ChIP signal strength.
