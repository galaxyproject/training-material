...
>
>  * Go to this [Galaxy library](https://usegalaxy.org/library/folders/Fe4842bd0c37b03a7)
...
>  * Click **Import**
>  * A green message will appear once the import is done. Click on it and will see the history you have just created. It will be populated with the four datasets.
>
{: .hands_on}
...
>
> 1. Use {% tool [MergeSAMFiles]() %} to merge the BAM datasets with the following parameters:
...
>
> 1. Use {% tool [MarkDuplicates]() %} to de-duplicate the merged BAM datasets with the following parameters:
...
>
> 1. Use {% tool [BamLeftAlign]() %} to perform left alignment with the following parameters:
...
>
> 1. Use {% tool [FreeBayes]() %} to call variants with the following parameters:
>    - *"Choose the source for the reference genome"*: `Locally cached`
...
>
> 1. Use {% tool [VCFfilter]() %} to filter the variants with the following parameters:
...
>
> 1. Use {% tool [VCFtoTab-delimited]() %} to filter the variants with the following parameters:
...
>
> 1. Use {% tool [Cut columns from a table]() %} to select specific columns with the following parameters:
