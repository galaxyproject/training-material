...
title: 'Trio Analysis of Autosomal Dominant Variant in Breast Cancer'
zenodo_link: ''
questions:
...
## Sub-step with **GEMINI inheritance pattern**
...
>        - *"Set of columns to include in the variant report table"*: `Full (report all columns defined in the GEMINI database variants table)`
>
>    ***TODO***: *Check parameter descriptions*
>
>    ***TODO***: *Consider adding a comment or tip box*
