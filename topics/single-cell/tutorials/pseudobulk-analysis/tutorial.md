...
>
> If your AnnData object lacks raw counts, you can use the {% tool [AnnData Operations](toolshed.g2.bx.psu.edu/repos/iuc/anndata_manipulate/anndata_manipulate/0.10.9+galaxy1) %} tool with *"Function to manipulate the object
