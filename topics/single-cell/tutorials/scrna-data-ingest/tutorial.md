...
An example of SCEasy Tool in action is shown below to convert Seurat to AnnData object. 
...
> 2a. Import the AnnData object from [Zenodo](https://zenodo.org/records/10397653)
>
>    ```
...
>    
> 2b. Alternatively, you can import history where we created the Seurat object: [Input history](https://singlecell.usegalaxy.eu/u/j.jakiela/h/ebi-scxa---anndata-scanpy-or-seurat-object-1)
>
>    {% snippet faqs/galaxy/histories_import.md %}
>
>
> 3. **Rename** {% icon galaxy-pencil %} the dataset `Seurat object`
>
{: .hands_on}


> <hands-on-title> Seurat to AnnData with SCEasy </hands-on-title>
>
> 1. {% tool [SCEasy Converter](toolshed.g2.bx.psu.edu/repos/iuc/sceasy_convert/sceasy_convert/0.0.7+galaxy1) %} with the following parameters:
>    - *"Convert From / To"*: `Seurat to AnnData`
>    - {% icon param-file %} *"Input object"*: `Seurat object`
...
>   
> 2. **Rename** {% icon galaxy-pencil %} the output `Converted AnnData file`.
>
...
That's just one tool being used, and now we can use output dataset in the [Filter, Plot, Explore workflow](https://singlecell.usegalaxy.eu/u/j.jakiela/w/copy-of-filter-plot-and-explore-single-cell-rna-seq-data-imported-from-uploaded-file-3) prepared for the AnnData input file! How awesome that is!
...
{% include _includes/cyoa-choices.html option1="Create CDS input for Monocle3 tutorial" option2="General AnnData to CDS conversion" default="Create CDS input for Monocle3 tutorial"
...
> 3. {% tool [Inspect AnnData](toolshed.g2.bx.psu.edu/repos/iuc/anndata_inspect/anndata_inspect/0.7.5+galaxy1) %} to extract genes and cells (to be used for Monocle).
