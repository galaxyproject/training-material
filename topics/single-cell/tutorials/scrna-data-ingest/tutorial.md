...
{% include _includes/cyoa-choices.html option1="Create CDS input for Monocle3 tutorial" option2="General AnnData → CDS conversion" default="Create CDS input for Monocle3 tutorial"
