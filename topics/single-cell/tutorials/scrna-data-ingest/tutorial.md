...
>    
> 4. Alternatively, you can import history where we created the Seurat object: [Input history](https://singlecell.usegalaxy.eu/u/j.jakiela/h/ebi-scxa---anndata-scanpy-or-seurat-object-1) 
>
>    {% snippet faqs/galaxy/histories_import.md %}
>
>
> 5. **Rename** {% icon galaxy-pencil %} the dataset `Seurat object`
> 6. Check that the datatype is `rdata`
>
