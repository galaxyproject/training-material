...
>    > > 2. The object ids generated by **Binary 2 Label** {% icon tool %} are relatively low. To make them visible the values have to be stretched to a larger range of visible intensity values.
>    > {: .solution }
>    {: .question}
{: .hands_on}
