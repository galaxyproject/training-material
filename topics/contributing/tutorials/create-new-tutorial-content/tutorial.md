...
congratulations          | {% icon   congratulations %}
curriculum               | {% icon   curriculum %}
details                  | {% icon   details %}
docker_image             | {% icon   docker_image %}
email                    | {% icon   email %}
exchange                 | {% icon   exchange %}
feedback                 | {% icon   feedback %}
galaxy-barchart          | {% icon   galaxy-barchart %}
galaxy-chart-select-data | {% icon   galaxy-chart-select-data %}
galaxy-columns           | {% icon   galaxy-columns %}
galaxy-cross             | {% icon   galaxy-cross %}
galaxy-dropdown          | {% icon   galaxy-dropdown %}
galaxy-eye               | {% icon   galaxy-eye %}
galaxy-gear              | {% icon   galaxy-gear %}
galaxy-history           | {% icon   galaxy-history %}
galaxy-info              | {% icon   galaxy-info %}
galaxy-library           | {% icon   galaxy-library %}
galaxy-pencil            | {% icon   galaxy-pencil %}
galaxy-refresh           | {% icon   galaxy-refresh %}
galaxy-save              | {% icon   galaxy-save %}
galaxy-scratchbook       | {% icon   galaxy-scratchbook %}
galaxy-selector          | {% icon   galaxy-selector %}
galaxy-tags              | {% icon   galaxy-tags %}
galaxy-upload            | {% icon   galaxy-upload %}
galaxy-wf-connection     | {% icon   galaxy-wf-connection %}
galaxy-wf-new            | {% icon   galaxy-wf-new %}
galaxy_instance          | {% icon   galaxy_instance %}
github                   | {% icon   github %}
gitter                   | {% icon   gitter %}
hall-of-fame             | {% icon   hall-of-fame %}
hands_on                 | {% icon   hands_on %}
help                     | {% icon   help %}
instances                | {% icon   instances %}
interactive_tour         | {% icon   interactive_tour %}
keypoints                | {% icon   keypoints %}
last_modification        | {% icon   last_modification %}
level                    | {% icon   level %}
linkedin                 | {% icon   linkedin %}
new-history              | {% icon   new-history %}
objectives               | {% icon   objectives %}
orcid                    | {% icon   orcid %}
param-check              | {% icon   param-check %}
param-collection         | {% icon   param-collection %}
param-file               | {% icon   param-file %}
param-files              | {% icon   param-files %}
param-repeat             | {% icon   param-repeat %}
param-select             | {% icon   param-select %}
param-text               | {% icon   param-text %}
...
wf-input                 | {% icon   wf-input %}
workflow                 | {% icon   workflow %}
workflow                 | {% icon   workflow %}
workflow-runtime-toggle  | {% icon   workflow-runtime-toggle %}
zenodo_link              | {% icon   zenodo_link %}
