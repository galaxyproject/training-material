...
The full contents of this plugin are provided in the [GitHub repository related to this material in `tree/master/topics/dev/files/hands_on-visualizations/alignment_rname_boxplot`]({{ site.github_repo }}/tree/master/topics/dev/files/hands_on-visualizations/alignment_rname_boxplot).
