...
author: "[Helena Rasche](https://training.galaxyproject.org/hall-of-fame/hexylena/), [Gallantries: Bridging Training Communities in Life Science, Environment and Health](https://training.galaxyproject.org/hall-of-fame/gallantries/), [Avans Hogeschool](https://training.galaxyproject.org/hall-of-fame/avans-atgm/), MIT licensed content from the [Galaxy Training Network](https://training.galaxyproject.org/)"
...
:::{.tip}
<div class="box-title tip-title" id="tip-package-not-found"><button class="gtn-boxify-button tip" type="button" aria-controls="tip-package-not-found" aria-expanded="true"><i class="far fa-lightbulb" aria-hidden="true" ></i> <span>Tip: Package not found?</span><span class="fold-unfold fa fa-minus-square"></span></button></div>
