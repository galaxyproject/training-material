...
:::{.comment}
<div class="box-title comment-title" id="comment" aria-label="comment box: "><i class="far fa-comment-dots" aria-hidden="true"></i><span class="visually-hidden"></span> Comment</div>
...
:::{.question}
<div class="box-title question-title" id="question-filling-a-table-vs-printing-values" aria-label="question box: Filling a Table vs. Printing Values"><i class="far fa-question-circle" aria-hidden="true"></i><span class="visually-hidden"></span> Question: Filling a Table vs. Printing Values</div>
...
:::{.question}
<div class="box-title question-title" id="question-filtering-in-sql-vs-filtering-in-r" aria-label="question box: Filtering in SQL vs. Filtering in R"><i class="far fa-question-circle" aria-hidden="true"></i><span class="visually-hidden"></span> Question: Filtering in SQL vs. Filtering in R</div>
