...
:::{.question}
<div class="box-title question-title" id="question-filling-a-table-vs-printing-values"><i class="far fa-question-circle" aria-hidden="true" ></i> Question: Filling a Table vs. Printing Values</div>
...
:::{.question}
<div class="box-title question-title" id="question-filtering-in-sql-vs-filtering-in-r"><i class="far fa-question-circle" aria-hidden="true" ></i> Question: Filtering in SQL vs. Filtering in R</div>
