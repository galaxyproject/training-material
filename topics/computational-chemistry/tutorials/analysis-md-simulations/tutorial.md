...
>    >    ```
>    > https://zenodo.org/record/2537734
>    >    ```
>
> **Option 2:**
> Import from your previous history, where you completed the [NAMD simulation tutorial]({{ site.baseurl }}{% link topics/computational-chemistry/tutorials/md-simulation-namd/tutorial.md %}).
>
