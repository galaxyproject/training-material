...
The data required can be generated by completing the [NAMD simulation tutorial]({{ site.baseurl }}{% link topics/computational-chemistry/md-simulation-namd/tutorial.html).  Access it from your history. Alternatively, download the data from the Zenodo link provided, or from the [dataset provided](https://usegalaxy.eu/u/tsenapathi/h/example-md-dataset---cellulase).
...
>
> **Option 2**
> Import from your previous history, where you completed the [NAMD simulation tutorial]({{ site.baseurl }}{% link topics/computational-chemistry/md-simulation-namd/tutorial.html &}).
>
> **Option 3**
