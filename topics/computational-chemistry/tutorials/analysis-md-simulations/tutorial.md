...
We'll carry out some basic analysis by calculating RMSD, RMSF and PCA. The tools use the [Bio3D package](http://thegrantlab.org/bio3d/index), developed by the [Grant lab](http://thegrantlab.org/).
