...
objectives:
    - Inspect the read quality (FastQC)
    - Trim bases with low quality (Trim Galore)
    - Map reads (Bowtie2)
    - Assess the quality of a ChIP-seq experiment (deeptools)
    - Extract coverage files (deeptools)
    - Call enriched regions or peaks (MACS2)
time_estimation: "3h"
key_points:
