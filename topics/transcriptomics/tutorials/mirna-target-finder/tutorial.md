...
> ### {% icon comment %} Comments
> One of the hyphothesis that can be infered from our results is: the inhibition of the BGAL10 protein translation can result in plants with a delayed fruit rippenning. Is it possible to validate it? Yes! We proporse this approach: to adquire [AT5G63810 mutant seeds](https://abrc.osu.edu/stocks?search%5Btaxon%5D=Arabidopsis+thaliana&search%5Bsearch_text%5D=AT5G63810&search%5Bmaterial_type%5D%5B%5D=seed&search%5Bsearch_fields%5D=All) and [wild type seeds](http://arabidopsis.info/StockInfo?NASC_id=N1093), grow them under two controlled conditions: watering and drought, and anayze plant weight after 33 days (fig.15).
>
