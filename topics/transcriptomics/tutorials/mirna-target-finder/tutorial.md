...
Next, we will extract those genes whose expression is statistically significant, selecting those whose adjusted p-value is less than 0.05. A cut-off value of 0.05 means that the probability of a false positive is less than five per thousand.
...
> > ### {% icon comment %} Comments
> > 
> > You can find that tool in the _Filter and Sort_ section.
> >
> {: .comment}
...
> ### {% icon question %} Questions
>
> 1. How many miRNAs show statistically significant upregulation?
> 2. And downregulation?
>
> > ### {% icon solution %} Solution
> >
> > 1. Unfortunately, we have not detected any upregulated miRNA. In this case, this is caused by the fact that the subsampled datasets don't have sufficient read depth to detect genes with low expression levels.
> > 2. We have identified 4 downregulated genes.
> > ![fig13a:Downregulated miRNA](../../images/miRNA_downregulated.png "Downregulated miRNAs.")
> {: .solution}
>
{: .question}
...
>
> ![fig15:Plant groWth](../../images/arabidopis_growth_protocol.png "_Arabidopsis_ growth conditions protocol ({% cite deOllas2019 %}).")
>
>
{: .comment}
