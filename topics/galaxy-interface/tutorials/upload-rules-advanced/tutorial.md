...
>    ![screenshot](http://galaxy-tests.s3.amazonaws.com/galaxy-gtn-screenshots/local/rules_example_5_1_inputs.png)
>
...
>    - Click `Apply`
>
>    ![screenshot](http://galaxy-tests.s3.amazonaws.com/galaxy-gtn-screenshots/local/rules_example_5_2_source.png)
>
>    You should now see the rules you created in the last example.
>    ![screenshot](http://galaxy-tests.s3.amazonaws.com/galaxy-gtn-screenshots/local/rules_example_5_3_initial_rules.png)
>
...
>       >   ![screenshot](http://galaxy-tests.s3.amazonaws.com/galaxy-gtn-screenshots/local/rules_example_6_3_end_of_table.png)
>       {: .solution}
>
