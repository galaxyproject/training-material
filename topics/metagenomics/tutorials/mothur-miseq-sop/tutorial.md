...
*"We were interested in understanding the effect of normal variation in the gut microbiome on host health. To that end,
...
time points (5 early and 5 late). In order to assess the error rate of the analysis pipeline and experimental setup, the Schloss lab
...
> `F3D0_S188_L001_R1_001.fastq` and
...
>
> From the Schloss lab: *"We have a very simple algorithm to do this. First, we align the pairs of sequences. Next, we look
