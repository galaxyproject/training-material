...
クオリティコントロールの最後のステップとして、データセットに"望ましくないもの"があるかを確認する必要があります。選択したプライマーセットによっては、18S rRNA の遺伝子断片や 古細菌、葉緑体、ミトコンドリア由来の16S rRNA が増幅されてしまいます。またランダム配列についても除去する必要があります。
