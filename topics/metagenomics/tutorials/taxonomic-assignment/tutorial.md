...
>    - * whta is kmer distribution? xxx
>    which kind of report?
>    what to do with bracken report? xxx
>
{: .hands_on}
...
## Convert output from Kraken2 so it can be used for Krona (xxx krakentools for converting doesn't work)
