...
> <comment-title></comment-title>
>
> We will need the outputs from this section in the next one.  If yours is still running or you get an error you can go on and upload it so you can start this workflow, the next hands-on is optional
>
...
>
> 1. Create a collection named `VFDB Accession Column` with `VFDB Accession` files
>
...
>    - *"text to add"*: `All_VFs`
>    - {% icon param-file %} *"input file"*: `output` (output of 2nd **Collapse Collection** {% icon tool %})
>
...
>    - {% icon param-file %} *"File to split"*: `output` (output of 1st **Collapse Collection** {% icon tool %})
>    - *"on column"*: `c13`
...
>    - {% icon param-file %} *"From"*: `output` (output of **Collapse Collection** {% icon tool %})
>
