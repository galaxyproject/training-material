...
>
> 2. Import the samples Fastq.qz files from [Zenodo]({{ page.zenodo_link }}) or Galaxy shared data libraries to each history respectively:
>
...
> <hands-on-title>Data upload</hands-on-title>
>
> 1. Import a tabular file from [Zenodo]({{ page.zenodo_link }}) or Galaxy shared data libraries to both histories; `Barcode10` and `Barcode11`:
>
...
> <hands-on-title>Data upload</hands-on-title>
>
> 1. Import a reference genome FASTA file from [Zenodo]({{ page.zenodo_link }}) or Galaxy shared data libraries to both histories; `Barcode10` and `Barcode11`:
>
...
>    {% snippet faqs/galaxy/histories_create_new.md %}
>
> 2. Copy the following datasets from `Barcode10` history to the new created history, then copy the same files from `Barcode11` history too.
>
>     a. VFDB Accession
