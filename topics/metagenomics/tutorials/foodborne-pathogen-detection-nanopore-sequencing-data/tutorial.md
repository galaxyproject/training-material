...
objectives:
    ...
    - Pre-processing the data by quality improving and host filtering
    ...
    - SNP based pathogenic identification via SNP calling and consensus gemone building of the samples
