...
>
> 1. Previous experience running at least one analysis on Galaxy.
...
>
> First, to do this, *you need to log in*.  If you haven't yet created an account, now is an ideal time to that.  Your current history will be saved as your first history under your new account.
>
> * At the top right of your history panel is an icon that looks like a table.  *Click* on that to switch to your histories view.
...
>    > This will make the history the current history and move it to the very left.
> * *Click* the **Done** button at the top upper left of your histories view.
>    > This will return you to the Galaxy home page with the selected history as your current history.
{: .hands_on}
...
>    > This luanches a form to create a workflow.
...
>    > If there are extra steps in the history that we don't need we will get rid of them in subsequent steps.
...
> ### {% icon tip %} Tip
> Note that you can also delete these steps when you are first extracting the workflow from your history, by unchecking them.  However, many people find it easier to identify the steps to drop in the workflow view, where connections and dead-ends are more obvious.
{: .tip}
...
> ### {% icon hands_on %} Run the workflow
>
