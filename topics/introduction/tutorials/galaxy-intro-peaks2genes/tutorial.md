...
>
> 1. **Select last** {% icon tool %}: Search for the **Select last** tool in the tool panel to the left and select the following settings:
...
>
> 1. **Get Flanks** {% icon tool %}: Run **Get Flanks**, which returns flanking regions for every gene with the following settings:
...
>
> 1. **Intersect** {% icon tool %}: Run **Intersect** with the following settings:
...
>
> 1. **Group** {% icon tool %}: Run **Group** with the following settings:
