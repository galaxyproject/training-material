...
>    {% snippet snippets/import_via_link.md format="interval" %}
>
...
>
>    {% snippet snippets/rename_dataset.md name="Genes" %}
>
...
>
>    {% snippet snippets/change_datatype.md datatype="interval" %}
>
...
>    ```
>
>    {% snippet snippets/import_via_link.md genome="mm9" %}
>
>    {% snippet snippets/import_from_data_library.md path='Click on "Training data" and then "Introduction - From peaks to genes"' %}
>
