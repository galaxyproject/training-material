...
It could be nice to use: [Processing many samples at once](https://galaxyproject.github.io/training-material/topics/introduction/tutorials/processing-many-samples-at-once/tutorial.html)
