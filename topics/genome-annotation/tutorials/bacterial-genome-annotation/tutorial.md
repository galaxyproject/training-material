...
- `Analysis_summary`: a summary of the analysis as text file
   ...
   > > 2. 2,911,349 bp, with is a bit shorter than the expected 2,914,567 bp
   > > 3. 2,717 CDSs, a bit more than the expected 2,704 CDSs
   > > 4. 5 sORFs
   > > 5. Other components
   > >    
...
- A summary with for each sequence in the input the number of identified CALIN elements, In0 elements, and complete integrons.
   ...
   > > <solution-title></solution-title>
   > >
   > > No integron elements have been found on any contig.
   > {: .solution}
   {: .question}
