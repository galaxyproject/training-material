...
> Sometimes tools fail and turn red. Often this is not the user's fault. Clicking on the name of the dataset will open details about the job.
>
> ![](../../images/introduction-to-cpt-galaxy-screenshots/9_report_bug.png)
>
> Selecting the bug icon in the bottom left-hand corner will bring up a page in the main Galaxy interface. There, a message can be typed and a report submitted to CPT IT. It is always recommended to submit bug reports when jobs fail because it improves the system for all users.
{: .comment}
