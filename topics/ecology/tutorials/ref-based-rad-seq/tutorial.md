...
>
>    {% snippet faqs/add_custom_build.md name="Stickleback" dbkey="stickleback" fasta="Reference_genome_11_chromosomes.fasta" %}
>
> 6. Next, we set the `dbkey` of our imported fastq files to our custom build key
>
>    {% snippet faqs/change_dbkey.md dbkey="stickleback" %}
>
