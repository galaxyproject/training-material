...
With the `output` from the last **Paste two files side by side** execution, you can now generate a new 'stacked' chart which will have a x-axis corresponding to your column `"week"`.
