...
Have a look at this plot. We can see that one of the value is above the threshold, therefore we observe autocorrelation in the data. We will now take into account the autocorrelation in te next model.
...
For this step you can use the scratchbook function in order to see both results at the same time.
