...
>
{: .hands_on}
> <hands-on-title> MultiQC </hands-on-title>
>
...
> <hands-on-title> Filter FASTQ </hands-on-title>
>
> 1. {% tool [Filter FASTQ](toolshed.g2.bx.psu.edu/repos/devteam/fastq_filter/fastq_filter/1.1.5) %} with the following parameters:
>    - *"Minimum size"*: `300`
>
>    > <comment-title> Comment </comment-title>
>    >
...
> <hands-on-title> Regex Find And Replace </hands-on-title>
>
...
> <hands-on-title> Paste </hands-on-title>
>
> 1. {% tool [Paste](Paste1) %} 
...
>
> 1. {% tool [NCBI BLAST+ blastn](toolshed.g2.bx.psu.edu/repos/devteam/ncbi_blast_plus/ncbi_blastn_wrapper/2.14.1+galaxy2) %} with the following parameters:
