...
>
> With the informations generated by Quast, compared the two assemblies to the reference genome
>
...
> > 1. 2128 Complete BUSCOs (of which 2128 are single-copy and 49 are duplicated),
...
> > 1. 1662 complete BUSCOs (1662 single-copy and 27 duplicated),
> > 2. 5 fragmented BUSCOs
> > 3. 470 missing BUSCOs.
> >
> >
> > BUSCO analysis confirms that Flye assembly is better than Hifiasm assembly. Flye it's also similar in completness to the reference genome with similar number of complete, fragmented and missing BUSCOs genes.
> >
> {: .solution}
>
{: .question}
