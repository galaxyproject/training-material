...
>
>   {% snippet faqs/rename_dataset.md name="E. coli C" %}
>
...
>
>    {% snippet faqs/rename_collection.md name="LASTZ Alignments" %}
>
{: .hands_on}
...
>
>    {% snippet faqs/convert_datatype.md conversion="Convert compressed to uncompressed" %}
>
...
>
>    {% snippet faqs/rename_dataset.md name="DNA (E. coli C + Relatives)" %}
{: .hands_on}
...
>
>    {% snippet faqs/rename_dataset.md name="Unprocessed Alignments" %}
>
...
>
>    {% snippet faqs/rename_dataset.md name="Target Alignments" %}
>
...
>
>    {% snippet faqs/rename_dataset.md name="Query Alignments" %}
>
...
>
>    {% snippet faqs/change_datatype.md datatype="bed" %}
>
>    {% snippet faqs/rename_dataset.md name="Target & Query Alignments" %}
>
{: .hands_on}
...
>   {% snippet faqs/change_datatype.md datatype="bed" %}
>
>   {% snippet faqs/rename_dataset.md name="Genes (E. coli Relatives)" %}
>
...
>   {% snippet faqs/change_datatype.md datatype="bed" %}
>
>   {% snippet faqs/rename_dataset.md name="Genes (E. coli Relatives) with Symbol Name" %}
>
{: .hands_on}
...
>
>    {% snippet faqs/rename_dataset.md name="Gaps" %}
{: .hands_on}
...
<ul>
  <li>{% snippet faqs/jbrowse-link.html datadir="data" loc="LT906474.1:3238836..3318993" tracks=jbtracks %}</li>
  <li>{% snippet faqs/jbrowse-link.html datadir="data" loc="CP020543.1:3246920..3310052" tracks=jbtracks %}</li>
  <li>{% snippet faqs/jbrowse-link.html datadir="data" loc="CP024090.1:3221116..3295268" tracks=jbtracks %}</li>
</ul>
