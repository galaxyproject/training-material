...
> ### {% icon hands_on %} Hands-on: Run FastQC on a fastq file
>
...
>
> #### 1. Run **FastQC** {% icon tool %} on **mutant_R1.fastq** to assess the quality of the input data.
>
...
> ### {% icon hands_on %} Hands-on: Run Velvet on the input reads
>
> #### 1. Run **Velvet** {% icon tool %} Run **velvet** on both the input read files **mutant_R1.fastq** and **mutant_R2.fastq**
>
...
>
> #### Run **Fasta statistics** {% icon tool %} on our contigs file
>
