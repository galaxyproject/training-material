...
>    >
>    > * Copy the links (Right-click on the filename then "Copy Link Address")
>    > * On the Galaxy Server, click on "Upload Data"
>    > * Select **Paste/Fetch Data**
>    > * Paste the link into the text field
>    > * Change the Type(set-all) to **fastqsanger**
>    > * Press **Start**
>    {: .tip}
>
...
>     Click on the **FastQC** {% icon tool %}  and change the following parameters
>     On "Raw read data from your current history" click (**Multiple datasets**) tab to select `mutant_R1.fastq` and `mutant_R2.fastq` (ctrl+click for multiple selection)
>   
>    
>
> 2.  Type **MultiQC**  in the tools panel search box (top) 
>     Click on the **MultiQC** {% icon tool %} and change the following parameters
