...
Here we will focus on the Caribbean sea surrounding the Antilles during April and May. The 9th of April 2021 an eruption of the volcano La Soufriere Saint Vincent (Antilles) occured. Another tutorials on this event is available on the [Galaxy Training Network]{% training.galaxyproject.org/training-material/topics/climate/tutorials/sentinel5_data/tutorial.html %}.
