...
For quality control, we use similar tools as described in [NGS-QC tutorial](http://galaxyproject.github.io/training-material/topics/sequence-analysis/tutorials/quality-control/tutorial.html): [FastQC](http://www.bioinformatics.babraham.ac.uk/projects/fastqc/).
