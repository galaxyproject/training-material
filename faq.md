...
We provide some QR codes and logos in the [images folder]({{ site.github.repository_url }}/tree/master/assets/images).
...
6. Submit a pull request from that branch to the [master repository]({{ site.github.repository_url }})
