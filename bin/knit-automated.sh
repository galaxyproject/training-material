...
declare -a tutorials
tutorials=(admin/ansible-galaxy admin/tus admin/cvmfs admin/singularity admin/tool-management admin/data-library admin/connect-to-compute-cluster admin/job-destinations admin/pulsar admin/gxadmin admin/monitoring admin/tiaas admin/reports admin/ftp admin/beacon)
