...
## TODO
## - Prepare CSV
##   - MAnage the redirect tutorials
## - Add feedback.md page with graphs
##   - Overall feedback
##   - Per topic
##   - Per tutorial
## - Add link to tutorial section in feedback page in tutorial page
...
def prepare_feedback(url, out_file):
    ...
    df = (pd.read_csv(url, sep='\t')
        ...
        .query('tutorial != "Galaxy Tool Management"')
